// Nesta atividade você deverá implementar uma lista simplesmente encadeada com tratamento de exceções e tipos genéricos.
// Na atividade foi anexado um arquivo contendo uma implementação de uma lista encadeada de inteiros e o programa principal (classe Main), que executará testes para verificação da corretude das estruturas de dados implementadas.
